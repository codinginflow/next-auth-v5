...
const Post: React.FC<PostProps> = ({ title, details }) => {
  return (
    <section className="bg-white">
      <div className="py-8 px-4 mx-auto max-w-2xl ">
        <h2 className="mb-2 text-xl font-semibold leading-none text-gray-900 md:text-2xl ">{title}</h2>
        <dl>
          <dt className="mb-2 font-semibold leading-none text-gray-900 ">Details</dt>
          <dd className="mb-4 font-light text-gray-500 sm:mb-5 ">{details}</dd>
        </dl>
